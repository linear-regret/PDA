...
{
    jack_default_audio_sample_t *in1, *out, *out2;
    int i, j;
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    for (int i = 0; i < fft_size; ++i)
    {
        ...
        // Arreglo en el que se calculan los delays
    ...
    if ((input_port1 == NULL) || (input_port2 == NULL) || (input_port3 == NULL) || (output_port == NULL) || (output_port2 == NULL))
    {
